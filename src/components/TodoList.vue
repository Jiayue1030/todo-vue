...
<script>
  export default {
    ...
    //computed property=composing new data derived from other data, they should not mutate any data, not accept params & always return sth
    computed: {
      remaining() {
    ...
    methods: {
      ...
      doneEdit(todo) {
        //avoid adding empty string and get back the title before editing
        if (todo.title.trim() == '') {
